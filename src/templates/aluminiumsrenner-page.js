...
export const AluminiumsrennerPageTemplate = ({
  title,
  forsidebilde,
  heading,
  technicalInfo,
...
AluminiumsrennerPageTemplate.propTypes = {
...
const AluminiumsrennerPage = ({ data }) => {
  const { frontmatter } = data.markdownRemark;

  return (
    <Layout>
      <AluminiumsrennerPageTemplate
...
AluminiumsrennerPage.propTypes = {
...
export default AluminiumsrennerPage;

export const pageQuery = graphql`
  query AluminiumsrennerPageTemplate {
    markdownRemark(
      frontmatter: { templateKey: { eq: "aluminiumsrenner-page" } }
    ) {
      frontmatter {
        title
        forsidebilde {
